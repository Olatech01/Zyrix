            ...
            <div className="w-full max-w-md">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input
                                ...
                                onChange={handleInputChange}
                                className="w-4 h-4 rounded border-neutral-600 bg-neutral-800 text-yellow-400 focus:ring-yellow-400 focus:ring-offset-0"
                            />
                            <span className="text-neutral-400 text-sm">Remember me</span>
                        </label>
                        <Link href="/auth/forgot-password" className="text-yellow-400 text-sm hover:text-yellow-500 transition-colors">
                            Forgot Password?
                        </Link>
                    </div>
                    ...
                    <p className="text-center text-neutral-400 text-sm">
                        ...
                        <Link href="/auth/signup" className="text-yellow-400 hover:text-yellow-500 transition-colors font-medium">
                            Sign Up
                        </Link>
                    </p>
                </div>
